      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
          <div>
            ...
            <p className="text-gray-600">{t('vaccine.stats.users')}</p>
          </div>
          <div>
            <span className="text-2xl font-bold text-green-600 block">50</span>
            <p className="text-gray-600">{t('vaccine.stats.vaccines')}</p>
          </div>
          <div>
            <span className="text-2xl font-bold text-purple-600 block">30</span>
            <p className="text-gray-600">{t('vaccine.stats.centers')}</p>
          </div>
          <div>
            <span className="text-2xl font-bold text-red-600 block">10</span>
            <p className="text-gray-600">{t('vaccine.stats.doctors')}</p>
          </div>
        </div>
      </div>
    </section>
