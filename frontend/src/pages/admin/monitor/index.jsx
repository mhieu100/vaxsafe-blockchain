...
const MonitorPage = () => {
  ...
  useEffect(() => {
    ...
    const handleNewBlock = (block) => {
      setBlocks((prev) => {
        const exists = prev.some((b) => b.number === block.number && b.hash === block.hash);
              ...
              <List.Item.Meta
                ...
                title={
                  <Space>
                    ...
                    {item.contractType && <Tag color="blue">{item.contractType}</Tag>}
              ...
              <List.Item.Meta
                avatar={
                  <div className="p-2 bg-purple-50 rounded-lg">
                    <span className="text-purple-500 text-xl">{getEventIcon(item.type)}</span>
                  </div>
                }
                title={
                  <Space>
                ...
                description={
                  <Space direction="vertical" size={4}>
                    ...
                    <div className="bg-gray-50 p-2 rounded text-xs">{formatEventDetails(item)}</div>
                  </Space>
                }
              />
            </List.Item>
      ...
      <Row gutter={[16, 16]} className="mb-6">
        <Col xs={24} sm={12} md={8} lg={4}>
          <Card bordered={false} className="shadow-sm">
            <Statistic title="Total Blocks" value={stats.totalBlocks} prefix={<BlockOutlined />} />
            <Text type="secondary" style={{ fontSize: 12 }}>
