      ...
      <div className="min-h-screen py-8 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-white certificate-border shadow-xl rounded-lg overflow-hidden">
                ...
                <div className="flex flex-col sm:flex-row gap-6">
                  ...
                  <div className="sm:w-1/3">
                    <div className="bg-gray-100 p-4 rounded-lg flex flex-col items-center">
                      ...
                      <p className="text-xs text-center text-gray-500 mt-1">vaxchain.io/verify/{transactionHash.slice(0, 6)}</p>
                    </div>
                  </div>
                    ...
                    <div className="space-y-4">
                      <div>
                        ...
                        <div className="flex items-center mt-1">
                          <p className="font-mono text-sm text-blue-600 truncate">{data.appointmentHash}</p>
                          <button 
                      ...
                      <div>
                        ...
                        <p className="font-medium">{dayjs(data.datetime).format('DD/MM/YYYY HH:mm')} UTC</p>
                      </div>
                      <div>
                        <p className="text-sm text-gray-500">Mã Giao Dịch</p>
                        <div className="flex items-center mt-1">
                          <p className="font-mono text-sm text-green-600 truncate">{data.paymentHash}</p>
                          <button 
                        ...
                        <div className="flex">
                          ...
                          <div className="ml-3">
                            <p className="text-sm text-blue-700">
                              Chứng nhận này được ký điện tử và lưu trữ bất biến trên blockchain Ethereum.
                            </p>
                          </div>
                        </div>
                      </div>
            ...
            <div className="bg-gray-50 px-6 py-4 border-t border-gray-200 flex flex-col sm:flex-row justify-between items-center">
              <div className="flex items-center mb-3 sm:mb-0">
                <i className="fas fa-shield-virus text-blue-600 mr-2"></i>
              ...
              <div className="flex space-x-3">
                ...
                >
                  <i className="fas fa-file-pdf mr-2"></i> Tải PDF
                </button>
              </div>
            </div>
          </div>
          ...
          <div className="mt-8 bg-white shadow rounded-lg overflow-hidden">
            <div className="p-6">
              <h3 className="text-lg font-medium text-gray-900 mb-4">Cách Xác Thực Chứng Nhận Này</h3>
                ...
                <div className="flex">
                  ...
                  <div className="ml-3">
                    <p className="text-sm text-yellow-700">
                      Vì lý do an ninh, luôn xác thực chứng nhận thông qua các kênh chính thức. Không chỉ dựa vào việc kiểm tra trực quan.
                    </p>
                  </div>
                </div>
              </div>
